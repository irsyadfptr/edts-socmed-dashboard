...
function ModalComment({wording, close, submit, name, email, msg}) {
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="mb-3 px-3 pt-3 xl:w-96">
                    <div className='flex mb-4 justify-between justify-between'>
                        <input defaultValue={name} onChange={name} className='w-5/12
                        px-3 py-1
                        text-base
                        font-normal
                        text-gray-700
                        ...
                        <input defaultValue={email} onChange={email} className='w-5/12 text-base px-3 py-1
                        font-normal
                        text-gray-700
                        bg-white bg-clip-padding
                        border border-solid border-gray-300
                        ...
                        ease-in-out
                        m-0
                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none' placeholder='Your email'/>
                    </div>
                    <textarea defaultValue={msg} onChange={msg}
                    className="
                        form-control
                        block
                        w-full
